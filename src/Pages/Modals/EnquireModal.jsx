  ...
  return (
    <>
      ...
      {status === "Unresolved" ? (
        ...
        <br />
        <p>Else, contact <span className="capitalize">{userName}</span> who created this item: {phone}</p>
        </>
}

{type === 'Lost' && <p>If you know anything about the whereabouts of this item, contact <span className="capitalize">{userName}</span> who created this item: {phone}</p>}
</>
      ) : (
        <>
        <p>
